...
export class FdElement extends LitElement {
  static get styles() {
    return css`
      ...
      .selected{
         border: solid 50px gray !important;
      }
  ...
  static get properties() {
    return {
      ...
      searchResultDataJson: {type: Array},
   ...
   previousPage()
  {
      if (this.currentPage > 1) {
        for (var index = (this.currentPage-1) * this.imagesPerPage; index < (this.currentPage * this.imagesPerPage) && index < this.searchResultData.length; index++) {
   ...
   displayPage(page)
  {
      ...
      var page_span = this.shadowRoot.getElementById("page");
   
      // Validate page
      if (page < 1) page = 1;
      if (page > this.numberOfPages()) page = this.numberOfPages();
      
      for (var index = (page-1) * this.imagesPerPage; index < (page * this.imagesPerPage) && index < this.searchResultData.length; index++) {
        //this.shadowRoot.getElementById("imageSearchList").innerHTML += this.searchResultData[index];
   ...
   numberOfPages()
  {
      return Math.ceil(this.searchResultData.length / this.imagesPerPage);
  }
